...
interface MessageCardProps {
    ...
    usersInChat?: UserDTO[]; // Thêm prop này nếu có
}
...
const MessageCard = (props: MessageCardProps) => {
    ...
    const usersInChatFromRedux = useSelector((state: RootState) => state.chat.currentChat?.users) || [];
    const usersInChat = props.usersInChat || usersInChatFromRedux;
                ...
                >
                    <List>
                        {heartUsers.map((userId, idx) => {
                            const user = usersInChat.find(u => u.id === userId);
                            return (
                                <ListItem key={userId + idx}>
                                    <ListItemText primary={user ? user.fullName : userId} />
                                </ListItem>
                            );
                        })}
                    </List>
